...
\
In short, this analysis shows how we can use computer generated commands to check the standard health of the ocean. By looking at the balance between nitrogen and phosphorus in the seawater samples, we can see if the microorganisms living there have the right "nutrients" to grow. In nature, these nutrients usually stay in a very specific 16-to-1 ratio, known as the Redfield Ratio.

Our plot shows that as phosphorus goes up, nitrogen follows it in a straight line, which tells us the chemistry of this water is consistent and predictable. Using a tool like Quarto makes this whole process "reproducible and reliable," meaning anyone can run our same steps and get the exact same results without having to manually recalculate the numbers or fix broken file links. It’s a clutterfree, automated way to turn raw numbers into clear projection of environmental damages
